...
from CTGAN.ctgan.data_sampler import DataSampler
from CTGAN.ctgan.data_transformer import DataTransformer
from CTGAN.ctgan.errors import InvalidDataError
from CTGAN.ctgan.synthesizers.base import BaseSynthesizer, random_state
...
train_data_df = pd.read_csv(f'/home/chiragpandav/Downloads/tableak_FT/updated_code/tableak_adult_gen/result_analysis/hello_2000_68per.data', delimiter=',', names=list(features.keys()), engine='python')
train_data_df=train_data_df[:64]
